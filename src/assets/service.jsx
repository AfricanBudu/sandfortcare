...
const Service = () => {
  return (
    <div className="px-[3.89vw] my-14 mt-[11.12vw] mb-20">
      <header className="text-[#16656F] font-Semibold_Grotesk text-header mb-[1.95vw]">OUR SERVICES</header>
      <p className="font-medium font-General_Sans text-[2.22vw] text-[#1f1f1fb9] mb-[1.95vw]">We offer healthcare <br/>services which include:</p>
