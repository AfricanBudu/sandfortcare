        ...
        <div className="grid my-[4.45vw] gap-y-[11.12vw]">
            <div className="flex justify-start items-center gap-x-[1.95vw]">
                ...
                <div className="flex items-start gap-x-[1.39vw]">
                    ...
                    <div className="grid gap-y-[1.39vw]">
                        <p className="font-Medium_Grotesk text-header leading-none text-[#000000]">Sign up</p>
            ...
            <div className="flex justify-start items-center gap-x-[1.95vw]">
                <div className="flex items-start gap-x-[1.39vw]">
                    ...
                    <div className="grid gap-y-[1.39vw]">
                        <p className="font-Medium_Grotesk text-header leading-none text-[#000000]">Select Care Plan</p>
                        <p className="font-medium font-General_Sans text-[2.23vw] leading-normal text-[#1f1f1fb9]">
            ...
            <div className="flex justify-start items-center gap-x-[1.95vw]">
                ...
                <div className="flex items-start gap-x-[1.39vw]">
                    ...
                    <div className="grid gap-y-[1.39vw]">
                        <p className="font-Medium_Grotesk text-header leading-none text-[#000000]">Make Payment</p>
                        <p className="font-medium font-General_Sans text-[2.23vw] leading-normal text-[#1f1f1fb9]">
